        ...
        <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-400 mt-1">
                    Configure your SentinelAI protection preferences and account links.
                </p>
            </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-slate-200 font-medium">
                                    Real-time Deep Scanning
                                </h4>
                                <p className="text-xs text-slate-500">
                                    Analyze incoming emails immediately upon arrival using Gemini Pro.
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ${
                                toggles.realTimeScan ? 'bg-emerald-500' : 'bg-slate-700'
                            }`}
                        >
                            <div
                                className={`w-4 h-4 rounded-full bg-white transition-transform duration-200 ${
                                    toggles.realTimeScan ? 'translate-x-6' : 'translate-x-0'
                                }`}
                            ></div>
                        </button>
                    </div>
                    ...
                    <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    Automatically move emails with &gt;90% risk score to Spam.
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ${
                                toggles.autoBlock ? 'bg-emerald-500' : 'bg-slate-700'
                            }`}
                        >
                            <div
                                className={`w-4 h-4 rounded-full bg-white transition-transform duration-200 ${
                                    toggles.autoBlock ? 'translate-x-6' : 'translate-x-0'
                                }`}
                            ></div>
                        </button>
                    </div>
                    ...
                    <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    Show desktop notifications when a threat is detected.
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ${
                                toggles.notifications ? 'bg-emerald-500' : 'bg-slate-700'
                            }`}
                        >
                            <div
                                className={`w-4 h-4 rounded-full bg-white transition-transform duration-200 ${
                                    toggles.notifications ? 'translate-x-6' : 'translate-x-0'
                                }`}
                            ></div>
                        </button>
                    </div>
                    ...
                    <div className="p-4 flex items-center justify-between hover:bg-slate-800/30 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    Anonymously contribute to the global SentinelAI threat database.
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ${
                                toggles.dataSharing ? 'bg-emerald-500' : 'bg-slate-700'
                            }`}
                        >
                            <div
                                className={`w-4 h-4 rounded-full bg-white transition-transform duration-200 ${
                                    toggles.dataSharing ? 'translate-x-6' : 'translate-x-0'
                                }`}
                            ></div>
                        </button>
                    </div>
