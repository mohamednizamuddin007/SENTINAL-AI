...
import { ShieldAlert, LayoutDashboard, ScanLine, Puzzle, Settings, Bot, Download } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  const menuItems = [
    ...
    { id: AppView.EXTENSION_SIM, label: 'Extension Sim', icon: Puzzle },
    { id: AppView.DOWNLOAD, label: 'Get Extension', icon: Download },
