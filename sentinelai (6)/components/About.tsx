    ...
    <div className="max-w-5xl mx-auto space-y-16 animate-in fade-in duration-500 pb-12">
      ...
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-lg text-slate-400 max-w-3xl mx-auto leading-relaxed">
          ...
          <br/><br/>
          We use <strong>Google's Gemini 1.5 Pro</strong> to perform cognitive analysis on emails, visually inspect screenshots for brand impersonation, and detect subtle linguistic anomalies that signal synthetic fraud.
        </p>
      </div>
